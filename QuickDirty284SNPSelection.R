...
CreateLocusControl.GCL(markersuite = "ChumParentage2015_284SNPs", username = "krshedd", password = "Ski10er!")
LOKI2R.GCL(sillyvec = "CMFISHCR13", username = "krshedd", password = "Ski10er!")
